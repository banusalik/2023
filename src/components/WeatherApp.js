...
function WeatherApp() {
  ...
  return (
    <div className="container mx-auto p-4 bg-slate-100">
      <h1 className="flex justify-center text-4xl font-bold mb-8 mt-8">
        Weather App
      </h1>
      <div className="flex flex-col items-center">
        <div className="mb-8">
          ...
          <button
            ...
            className="bg-blue-500 text-white rounded-r-lg px-8 py-4 hover:bg-blue-600 transition duration-300 ease-in-out"
          >
            Search
          </button>
        </div>
